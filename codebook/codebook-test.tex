...
\fancyhead[L]{National Taiwan Ocean University La\_Team.cpp}
\fancyhead[R]{\thepage}
...
\lstinputlisting{basic/defalt.cpp}
...
\subsection{Gaussian Elimination 高斯消}
...
\subsection{Tangent line of two circles 兩圓共同切線}
...
\subsection{Min Mean Cycle 最小環平均}
\lstinputlisting{graph/MinMeanCycle.cpp}

\subsection{Directed Graph Min Cost Cycle 最小環}
\lstinputlisting{graph/DirectedGraphMinCycle.cpp}

\subsection{K-th Shortest Path 第K短路徑}
...
\lstinputlisting{dataStructure/linklist.cpp}
...
\subsection{Bit Index Tree}
\lstinputlisting{dataStructure/BitIndexTree.cpp}

\subsection{持久化 Segment Tree}
\lstinputlisting{dataStructure/Persistentds.cpp}
...
% xelatex  --max-print-line=10000 -synctex=1 -interaction=nonstopmode -file-line-error -recorder .\codebook-test.tex